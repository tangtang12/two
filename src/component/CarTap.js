      ...
      <div className="fix">
        <div className="shopping">
          <div className="shopTop">
            ...
            <a href="javascript:;" className="click" onClick={this.exit}>
              x
            </a>
          </div>
          <div className="title">
            <div className="small">
              ...
              <RadioGroup
                defaultValue={this.state.color ? this.state.color : ""}
            ...
            <div className="small">
              <span className="name">尺码</span>
              <RadioGroup
                defaultValue={this.state.size ? this.state.size : ""}
          ...
          {type ? (
            <div className="bottom">
              ...
              <a href="javascript:;" onClick={this.addToCar.bind(this, id)}>
                加入购物车
              </a>
            </div>
          ) : (
